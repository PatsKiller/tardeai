# Aegis Morning Brief — 2026-05-11
*Generated: 2026-05-11 20:54 ET*

---

## Executive Summary
Portfolio $1,191,456. Heat 0.3%. 0 stops triggered, 11 unprotected. 9 items flagged for Steph review. Covered calls: 1 candidates, 11 need review, 1 avoid

## 1. IMMEDIATE RISK
- 6 stop(s) TRIGGERED: RTX, LHX, LMT, LDOS, NOC, KBR. Check /v2/risk immediately.
- 1 in danger zone: AVAV.
- 11 large positions without stops ($581,764 total).

## 2. STEPH REVIEW NEEDED
- CACI: CACI danger — $484.30 vs stop $475.38 1.8% from stop → /v2/approvals
- BAH: BAH danger — $75.10 vs stop $74.87 0.3% from stop → /v2/approvals
- TDG: TDG danger — $1198.63 vs stop $1164.61 2.8% from stop → /v2/approvals
...
---
*Aegis Portfolio Intelligence | 2026-05-11 | Provenance: model=aegis*
