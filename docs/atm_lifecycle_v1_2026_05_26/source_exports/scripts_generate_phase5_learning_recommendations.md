# Source Export: scripts/generate_phase5_learning_recommendations.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/generate_phase5_learning_recommendations.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `703caf6fe3924f13b7cc3a306610b3848584c2a4e275a1b8c5104146128aebd1` |
