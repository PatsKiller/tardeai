# Source Export: scripts/research_insight_extractor.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/research_insight_extractor.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `d6237e9d0f7897de580d49ecaeaf642a771e5b3c4072b303c605672e3edb2a71` |
| **File Size** | 10048 bytes |
