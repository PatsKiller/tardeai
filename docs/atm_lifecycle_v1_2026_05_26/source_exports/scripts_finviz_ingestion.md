# Source Export: scripts/finviz_ingestion.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/finviz_ingestion.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `00dda1f17cfd837cfe142e4cced1af20a2ba284e5adf969331d75d5d8e7a14c0` |
| **File Size** | 15071 bytes |
