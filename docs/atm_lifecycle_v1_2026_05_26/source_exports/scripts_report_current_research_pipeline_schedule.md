# Source Export: scripts/report_current_research_pipeline_schedule.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_current_research_pipeline_schedule.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `938411615c256df9af271632c59ef97b5e1224a6dcd08d5b89d0023264e91bd5` |
| **File Size** | 8315 bytes |
