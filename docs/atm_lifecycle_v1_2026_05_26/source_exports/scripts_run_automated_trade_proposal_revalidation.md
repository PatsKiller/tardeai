# Source Export: scripts/run_automated_trade_proposal_revalidation.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/run_automated_trade_proposal_revalidation.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `43f9ff68f70a700eae8ea5e70f336e8c7938953b6fe5140fa048f6c435dbcae8` |
| **File Size** | 9628 bytes |
