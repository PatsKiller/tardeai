# Source Export: scripts/market_regime_classifier.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/market_regime_classifier.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `b52abf6f6bcbfebb915ab70de2bb3ad0156b418e6bf59f80927be2f097d126ee` |
