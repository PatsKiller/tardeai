# Source Export: scripts/canonical_closed_trade_adapter.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/canonical_closed_trade_adapter.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `6519a1383cf5437c26648d92f78a54ae414f1b18e00c019baf703e169202eb21` |
