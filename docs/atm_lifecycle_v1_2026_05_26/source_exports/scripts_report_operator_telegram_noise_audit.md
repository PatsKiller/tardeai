# Source Export: scripts/report_operator_telegram_noise_audit.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_operator_telegram_noise_audit.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `e1b401699f94f1c6e81418c10ee67bb1931aff80142d57187debe01b0f89b08c` |
| **File Size** | 7074 bytes |
