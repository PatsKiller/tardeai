# Source Export: scripts/proposal_llm_review_worker.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_llm_review_worker.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `6ba1b8c446034d0e59f428ce3e4cb4fd4af351dcecef09a15b7ac21792792aa3` |
| **File Size** | 7218 bytes |
