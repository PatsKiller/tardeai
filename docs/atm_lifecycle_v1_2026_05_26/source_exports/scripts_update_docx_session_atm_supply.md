# Source Export: scripts/update_docx_session_atm_supply.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/update_docx_session_atm_supply.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `0f2f3acd506a7c469f701a2a866617bd432140e0e42df419eba388bfbe49906c` |
| **File Size** | 12991 bytes |
