# Source Export: scripts/run_scheduled_atp2_research_cycle.sh

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/run_scheduled_atp2_research_cycle.sh` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `f42bf60bfcc439991283349ba7346a2f19493f96ce55f5737df878f1cddf206b` |
