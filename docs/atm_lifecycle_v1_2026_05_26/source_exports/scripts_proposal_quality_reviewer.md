# Source Export: scripts/proposal_quality_reviewer.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_quality_reviewer.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `2943597dfed1fe60806fa53d2f6113a519a83fcb7b75a7350bfce99043caf865` |
| **File Size** | 11063 bytes |
