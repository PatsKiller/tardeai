# Source Export: scripts/proposal_research_packet_builder.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_research_packet_builder.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `730b1142a1f8be06e1e63df97b0c04999046a7092cb179c5e47be079a9a7fd12` |
| **File Size** | 22539 bytes |
