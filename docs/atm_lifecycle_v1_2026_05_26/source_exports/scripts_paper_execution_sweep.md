# Source Export: scripts/paper_execution_sweep.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/paper_execution_sweep.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `1109ebcb669dde98173ecbdbebbbc63de29e629dd0a68fd68b464d8065d8a940` |
