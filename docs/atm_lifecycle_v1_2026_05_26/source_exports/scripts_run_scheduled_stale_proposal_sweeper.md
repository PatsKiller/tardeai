# Source Export: scripts/run_scheduled_stale_proposal_sweeper.sh

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/run_scheduled_stale_proposal_sweeper.sh` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `f14601911939c1177fb06b82c2101c1e618df5efe3d5d17f5acadf36e90d64c3` |
