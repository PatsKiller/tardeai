# Source Export: scripts/scalp_critic_agent.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/scalp_critic_agent.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `cfb692adc4fb0ca5fd825bfa66b0e1bb03773b8c7632eebde3a48162ba0795bd` |
| **File Size** | 16104 bytes |
