# Source Export: scripts/market_regime_collector.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/market_regime_collector.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `2d3530a34485be246fdf980e31f2e29da6bd1fb733123770694c6d1b98cba494` |
| **File Size** | 7715 bytes |
