# Source Export: scripts/live_trading_gate.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/live_trading_gate.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `86bef2f6a300f6b971860a29473f3966370947531f8afa35a8d5a0497cb57bc7` |
| **File Size** | 7126 bytes |
