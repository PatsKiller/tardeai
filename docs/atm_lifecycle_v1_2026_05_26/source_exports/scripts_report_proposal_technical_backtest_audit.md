# Source Export: scripts/report_proposal_technical_backtest_audit.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_proposal_technical_backtest_audit.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `489a592b7f4ec4ac8ba265dfc0de10811a2464a550858dffc0e453d1282dd95a` |
| **File Size** | 9945 bytes |
