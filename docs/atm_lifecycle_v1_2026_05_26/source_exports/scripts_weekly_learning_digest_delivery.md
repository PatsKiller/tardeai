# Source Export: scripts/weekly_learning_digest_delivery.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/weekly_learning_digest_delivery.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `ccacd386bc4d743de64970f08c27f16c4ab2773d49e5625b45c4eadd9b0a8e10` |
| **File Size** | 4793 bytes |
