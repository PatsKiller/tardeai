# Source Export: scripts/run_atp_alert_evaluator.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/run_atp_alert_evaluator.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `d293646b4772bb124161807f83da4850f8e6467173eab4756ab0bf277c879418` |
