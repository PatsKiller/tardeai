# Source Export: scripts/proposal_backtest_engine.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_backtest_engine.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `80f7e945f1b276a1c16d3aedfab4f98aceec34d4aab7ae60f0d537bf5ae634bb` |
| **File Size** | 18515 bytes |
