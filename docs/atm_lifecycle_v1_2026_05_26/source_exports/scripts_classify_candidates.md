# Source Export: scripts/classify_candidates.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/classify_candidates.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `0d982be08fff1295ac5d553bec5850622073751310cdcea17ce889518bdcd9e1` |
| **File Size** | 6103 bytes |
