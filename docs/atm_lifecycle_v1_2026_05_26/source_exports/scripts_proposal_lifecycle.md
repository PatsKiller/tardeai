# Source Export: scripts/proposal_lifecycle.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_lifecycle.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `96a81c0f277dc3a7f43fcdd09e3005a8ac3edc3949f97193bfaec7dc35531911` |
| **File Size** | 8987 bytes |
