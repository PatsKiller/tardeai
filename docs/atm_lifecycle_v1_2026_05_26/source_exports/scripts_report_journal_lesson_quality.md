# Source Export: scripts/report_journal_lesson_quality.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_journal_lesson_quality.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `d224cc72bac0ecee1eaf3963d8c1cafc0f16c5d43bbe349b8664a32793bd537d` |
| **File Size** | 3941 bytes |
