# Source Export: scripts/iris_taxonomy_agent.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/iris_taxonomy_agent.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `8d378483e8c359e8333e8c3aeadfed8f80c6d149bce4fe9da6ce43e88421cb6a` |
| **File Size** | 92064 bytes |
