# Source Export: scripts/report_promoter_quote_age_gate_gap.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_promoter_quote_age_gate_gap.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `29375479e371e4d80c7262930c250b8ef40558c07a6ab8d18a6455f28311336e` |
