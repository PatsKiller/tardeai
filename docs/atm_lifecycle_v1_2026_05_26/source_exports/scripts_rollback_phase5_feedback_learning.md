# Source Export: scripts/rollback_phase5_feedback_learning.sh

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/rollback_phase5_feedback_learning.sh` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `6ad4a2195d21f75d9e7c73cefcb031703aa64f31488dbe13d6c0ccece0409eb0` |
