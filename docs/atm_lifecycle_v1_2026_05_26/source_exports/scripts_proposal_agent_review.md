# Source Export: scripts/proposal_agent_review.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_agent_review.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `31ef7148c31496470df9f720900495d7da99357f5f194ee2e854889c3dad3d8a` |
| **File Size** | 18994 bytes |
