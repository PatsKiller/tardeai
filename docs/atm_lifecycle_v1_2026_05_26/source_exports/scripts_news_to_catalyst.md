# Source Export: scripts/news_to_catalyst.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/news_to_catalyst.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `4733acb669eb73e995cdf27df67c23079e529f3c481cc2fa6a167dac87b4dbef` |
| **File Size** | 6706 bytes |
