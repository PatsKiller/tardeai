# Source Export: scripts/bootstrap_agent_coverage.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/bootstrap_agent_coverage.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `2d2e8d4ad189723e95da1f8806d0ceb5fc65fffb8dbddb55b0287723a422812e` |
| **File Size** | 6612 bytes |
