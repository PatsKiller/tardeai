# Source Export: scripts/candidate_discovery_orchestrator.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/candidate_discovery_orchestrator.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `fabe078930ff61a99177f61496bada0f2430c7e63a98a48d3e14ceeb95cf209f` |
| **File Size** | 7241 bytes |
