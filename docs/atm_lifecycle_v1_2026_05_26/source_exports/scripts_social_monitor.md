# Source Export: scripts/social_monitor.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/social_monitor.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `9d91d0aa23c51ad3a4ce96b4c478179e6f9575528425e693ca2953acad6493cd` |
| **File Size** | 14239 bytes |
