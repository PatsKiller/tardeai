# Source Export: scripts/_news_strategy_classifier.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/_news_strategy_classifier.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `8fc6cc328d30bb16f095a0309a13779e6ffdf06d99e5850946277c61c98e3c88` |
| **File Size** | 7268 bytes |
