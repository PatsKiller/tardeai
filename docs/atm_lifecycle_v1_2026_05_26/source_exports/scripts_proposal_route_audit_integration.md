# Source Export: scripts/proposal_route_audit_integration.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/proposal_route_audit_integration.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `bc5da59d4fd7bf873a3fc55bfa033b1ba06e8a2364270d178a4d57e8aac198eb` |
| **File Size** | 4522 bytes |
