# Source Export: scripts/credential_monitor.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/credential_monitor.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `7de2e41ecad48d986b438facf0991c01060470072a231b4b3189c6fe9f35b967` |
| **File Size** | 14148 bytes |
