# Source Export: scripts/paper_performance_governance.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/paper_performance_governance.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `3f9232212b2bffe4a8efbf56d2e6e290a1a9a7fc27637ee7dedf07433f76ce52` |
