# Source Export: scripts/strategy_eligibility_gate_policy.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/strategy_eligibility_gate_policy.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `cb0440925aea20a2905be7326277d9897bbb6f9ea95ae45c9aba941b342e16e0` |
