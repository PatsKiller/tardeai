# Source Export: scripts/report_regime_cron1_schema_contract.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/report_regime_cron1_schema_contract.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `d84539523c9bbae738f8dc96a9b6671c9536774108d5eaacf416c168d27c6291` |
