# Source Export: scripts/journal_agent_coach.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/journal_agent_coach.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `deadf7c519b14d260416ebcf60f2dd9915fb072d38bcada25b0aacded23acea6` |
| **File Size** | 14834 bytes |
