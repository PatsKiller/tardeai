# Source Export: scripts/session27_validate_tca_reconciliation_outcomes.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/session27_validate_tca_reconciliation_outcomes.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `39edbb62b4e093f0505a7237ae9a1829bb0256a9b24eb903d360a1b4c2e1afca` |
