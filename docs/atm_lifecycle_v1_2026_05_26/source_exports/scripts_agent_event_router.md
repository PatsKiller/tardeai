# Source Export: scripts/agent_event_router.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/agent_event_router.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `bb281c3876f1e948428e5fe2c075020058a50976fce23f3a12bddb0f04d468c9` |
| **File Size** | 23483 bytes |
