# Source Export: scripts/audit_direct_telegram_senders.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/audit_direct_telegram_senders.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `f5fc30fbbc29a5946ee75372dcc0247eb21aeee1a36a1cd1c95eb16ac225792d` |
| **File Size** | 7794 bytes |
