# Source Export: scripts/paper_trade_logger.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/paper_trade_logger.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `2bc5a3bafb6380b86bf7e23586e9228b5c1b98be844ac83675a152199a0ff8b8` |
| **File Size** | 63348 bytes |
