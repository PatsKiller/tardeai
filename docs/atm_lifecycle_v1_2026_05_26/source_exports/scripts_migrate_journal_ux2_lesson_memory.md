# Source Export: scripts/migrate_journal_ux2_lesson_memory.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/migrate_journal_ux2_lesson_memory.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `30405031c7813ebbc25e621d9887683b4a0fe00f0129727574ba37a23a5f3c17` |
| **File Size** | 5328 bytes |
