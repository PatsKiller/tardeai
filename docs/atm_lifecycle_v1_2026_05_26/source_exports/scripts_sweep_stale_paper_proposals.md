# Source Export: scripts/sweep_stale_paper_proposals.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/sweep_stale_paper_proposals.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `8d6579c161ce76bbd308ec09ab17b5e20ad15d95797a9aaf584f9efe89fee70b` |
| **File Size** | 8143 bytes |
