# Source Export: scripts/agent_watchlist_engine.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/agent_watchlist_engine.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `e8c4800727eab59cd31d9aa37d328ddae3da2d0ffc4c39ae0dc5afe9d4d2345c` |
| **File Size** | 52613 bytes |
