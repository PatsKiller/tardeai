# Source Export: scripts/backfill_phase8_paper_trade_lifecycle_outcomes.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/backfill_phase8_paper_trade_lifecycle_outcomes.py` |
| **Git Branch** | `main` |
| **Git Commit** | `915876f` |
| **Export Timestamp** | `2026-05-26T19:48:00Z` |
| **SHA256** | `65b4cef33e6a51b9351b46b0eebb46bcf95a1d43a0291dd0a3b5fc9e0f825f3f` |
