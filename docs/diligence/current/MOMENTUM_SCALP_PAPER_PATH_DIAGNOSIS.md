...
| proposals_pending | 0 |
| auto_proposal_decisions | SKIPPED_STRATEGY_CRITERIA=332, SKIPPED_OUTSIDE_RTH=283, SKIPPED_NOT_GO=175, SKIPPED_LIQUIDITY=156, SKIPPED_RECENTLY_REJECTED=132, CREATED=63, SKIPPED_DUPLICATE=39, SKIPPED_RECENTLY_CLOSED=37, SKIPPED_OPEN_TRADE=17, SKIPPED_NO_ANALYST=14, SKIPPED_LOW_SCORE=5, SKIPPED_STALE_QUOTE=5, SKIPPED_PREPROMOTION=1 |
...
> Read-only diagnosis. No broker writes. Sandbox-only. Operator/2FA path unchanged.
