...
|----------|--------------|----------------|
| `PGPASSWORD='***REMOVED***'` | `PGPASSWORD="$DB_PASSWORD"` | collaboration_handoff, tier_1, tier_2, session |
| `PASSWORD '***REMOVED***'` | `PASSWORD '$DB_PASSWORD'` | session |
| `DB_PASSWORD=***REMOVED***` | `DB_PASSWORD=$DB_PASSWORD  # from .env` | session |
