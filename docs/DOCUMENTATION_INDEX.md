...
| `docs/design/OCO_ATM_UNIFICATION_DESIGN.md` | **OCO brackets + ATM↔proposals unification design** — Alpaca native OCO / Schwab API OCO (2FA) / Fidelity manual; auto-bracket at fill | Design (2026-06-29, not yet implemented) |
