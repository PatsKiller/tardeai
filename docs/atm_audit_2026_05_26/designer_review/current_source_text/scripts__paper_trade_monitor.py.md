# Source Export: scripts/paper_trade_monitor.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/paper_trade_monitor.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:48:59Z` |
| **SHA256** | `9f3f4965fa1a51080b3317d573b6bf00036415a5d40585ed06921a85bc3f022a` |
| **File Size** | 20702 bytes |
