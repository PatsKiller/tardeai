# Source Export: scripts/send_screener_schedule_health_alert.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/send_screener_schedule_health_alert.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:50:11Z` |
| **SHA256** | `7d069ddd35c3dfd371377aa0e1f50cd862a362227319bc17dc783d915666bba4` |
| **File Size** | 10143 bytes |
