# Source Export: scripts/monitoring/classifier_health_check.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/monitoring/classifier_health_check.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:52:51Z` |
| **SHA256** | `7deb90919fecb7a5e2e8807c01df4ad39164085154bfaa29c26278b0ccb00c4d` |
