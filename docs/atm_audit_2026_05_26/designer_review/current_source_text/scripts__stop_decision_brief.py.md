# Source Export: scripts/stop_decision_brief.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/stop_decision_brief.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:50:11Z` |
| **SHA256** | `be9506ef85e6a370c98826077b2d3b88af83feb9df8627583a5362edffdf732a` |
| **File Size** | 18058 bytes |
