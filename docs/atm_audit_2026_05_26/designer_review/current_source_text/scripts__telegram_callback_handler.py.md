# Source Export: scripts/telegram_callback_handler.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/telegram_callback_handler.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:50:11Z` |
| **SHA256** | `2e5e644642026da1e1020bddf60a2ca69f5f8aaf7b49c8b7ca791c30e19c7722` |
