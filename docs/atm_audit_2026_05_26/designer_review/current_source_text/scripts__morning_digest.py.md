# Source Export: scripts/morning_digest.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/morning_digest.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:50:11Z` |
| **SHA256** | `bc7afc467922c993865894cd9941fa65c75b00773b8482dc4c73bfa2edfe9dea` |
| **File Size** | 10766 bytes |
