# Source Export: scripts/open_trade_monitor.py

| Field | Value |
|-------|-------|
| **Original Path** | `scripts/open_trade_monitor.py` |
| **Git Branch** | `main` |
| **Git Commit** | `c1286d314deb377df49713e1646f139db7f43643` |
| **Export Timestamp** | `2026-05-26T15:50:11Z` |
| **SHA256** | `ffab02c11e7d15c4f30839f40a7a75ec654ede41ba5e0aa93c178b15623b2cca` |
| **File Size** | 30773 bytes |
