...
Mechanical Track A/B numbers are in `scorecard.json` and `docs/ops/LANE_QUALITY_BAKEOFF_2026-08-21.md`.
Rescued from `/tmp/tradeai-bakeoff-20260821/` on 2026-08-21 (volatile; tmpreaper/reboot would delete).
