...
function buildActionBoard(ctx: ChatCtx, ov: OverviewData | null, rk: RiskData | null): ActionRow[] {
  ...
  for (const d of johnDeferred.slice(0, 2)) rows.push({ id: `deferred-${d.id}`, rank: ++rank, severity: 'low', family: 'Deferred', symbol: d.symbol, headline: d.title, detail: 'Deferred — revisit scheduled.', exposure: null, owner: 'John', due: d.revisit_on || 'Later', confidence: null, cta: 'Review', route: '/approvals' })
