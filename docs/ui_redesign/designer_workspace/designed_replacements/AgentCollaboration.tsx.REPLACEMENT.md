# Replacement: AgentCollaboration.tsx — Agent Collaboration & Outcomes with RACI
...
- **Version:** 2.0 — RACI integration, clickable agent filtering, collaboration quality
- **Design summary:** Adds RACI process ownership via existing RACIMatrix component, clickable agent chips for filtering, Missions/RACI Map tab toggle, collaboration quality section with honest telemetry gap messaging, "Completed" filter, and "Waiting on Agent" scorecard.
...
- [ ] Top scorecard: Ready for John, Blocked, Waiting on Agent, Stale, System Trust (all clickable)
- [ ] John's Next Actions preserved
- [ ] Filter chips: All, Ready, Blocked, Waiting, Stale, Running, Completed
- [ ] Agent chips clickable — filter missions by agent
- [ ] Active agent filter shown as clearable chip
- [ ] Two-pane layout: Mission Queue (42%) + Mission Inspector
- [ ] Inspector Section A: Mission Summary
- [ ] Inspector Section B: RACI via RACIMatrix component (fetched per owner)
- [ ] Inspector Section C: Why This Matters (conditional)
- [ ] Inspector Section D: Current Blockers (red)
- [ ] Inspector Section E: Agent Contributions (AgentChip + showRole, clickable)
- [ ] Inspector Section F: What John Should Do (green card + ActionButton)
- [ ] Inspector Section G: Mission Items (thread list + StatusBadge)
- [ ] Inspector Section H: Stats footer
- [ ] Collaboration Quality section with link to /agent-calibration
- [ ] Missions / RACI Map tab toggle
- [ ] RACI Map fetches all known agents and shows RACIMatrix per agent
- [ ] Empty states with honest text
- [ ] Same API: useApi('/api/v2/agent-collaboration')
- [ ] RACI via useState + fetch (dynamic agent param)
- [ ] No trading/approval execution
- [ ] No new backend endpoints
- [ ] Correct prop signatures (name not agent, children not label)
