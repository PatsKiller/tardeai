# Replacement: Shell.tsx — Phase 1 Navigation Restructure

- **Target repo path:** apps/command-center-v2/src/components/Shell.tsx
- **Current source export:** current_source_text/Shell.tsx.md
- **Original SHA256:** 19ffdc2faf4b23533ea8f7edcf816730134bf39478385582157ac7a95b3b65b7
- **Replacement SHA256:** (compute after apply)
- **Replacement timestamp:** 2026-05-25
- **Design summary:** Reorganize NAV_GROUPS from 10 groups (with 17-item Admin) to 12 focused groups. Trade AI, Prospects, Strategy Desk, Incubator, ATM move to Trading. Self-Improvement, Agent Calibration, Weekly Learning move to Learning & Improvement. Agent Collaboration moves to Command. Execution Quality and Proposal Alerts move to Paper Trading. Backtesting moves to Reports. Admin reduced from 17 to 7.

## What Changed

Only the `NAV_GROUPS` array (lines 21-95 of original). Every other line is identical.

## Acceptance Checklist

- [ ] Only NAV_GROUPS changed
- [ ] All 52 route paths preserved — zero URL changes
- [ ] Admin reduced from 17 to 7 items
- [ ] Trading group created (5 items)
- [ ] Learning & Improvement group created (3 items)
- [ ] Agent Collaboration in Command
- [ ] Reports includes Backtesting
- [ ] Paper Trading includes Execution Quality + Proposal Alerts
