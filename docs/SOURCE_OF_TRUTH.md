...
| **symbol_identity** | ingested | `symbol_profiles` | UNCONSOLIDATED → `scripts/build_symbol_profiles.py` (8 writers today; ceiling may only fall) | 06:35 daily | 168h | `symbol_profile` | yfinance | finviz | fmp | `say_so` | operator 2026-09-13 |
...
| **catalyst_news** | ingested | `news_articles` | UNCONSOLIDATED → `scripts/news_ingestion.py` (16 writers today; ceiling may only fall) | 00:30 · 12:30 | 12h | `catalyst_record` | finviz | yahoo, brave, searxng | finnhub, newsapi, polygon, fmp | `say_so` | operator 2026-09-13 |
...
| **symbol_identity** | `symbol_profiles` | 8 | `scripts/build_symbol_profiles.py` | 11 |
