...
R3 — ALMANAC REPRODUCTION          MERGED  #330 / 08be8976
R4 — RETRIEVAL / DECISION-USE      MERGED  #330 / 08be8976  (dry adapter)
R5 — CPCV PATH CONSTRUCTION        THIS PR (R5A-1)
R6 — APPEND-ONLY GOVERNANCE STORE  THIS PR (R6A-1)
R7 — POLICY + BEHAVIORAL           THIS PR (R7A-1)
R8 — EMPIRICAL FACTOR / STRATEGY   THIS PR (R8A-1)
```
