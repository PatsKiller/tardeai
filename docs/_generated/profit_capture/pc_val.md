...
| quality-gated run present | ✅ | run_id=ppbt_auto_20260607, rows=12 |
| raw n AND reliable n reported | ✅ | 12 rows |
| confidence keyed to reliable n | ✅ | low-reliable rows are 'insufficient' |
| premature cost path-measured where path exists | ✅ | 11 path_measured rule rows; all known=true=True |
| estimate quality honestly labelled | ✅ |  |
| intrabar paths ingested | ✅ | 11383 bars / 31 trades |
| rule graft verdicts blocked | ✅ | max_reliable_n=11 (floor 20) |
