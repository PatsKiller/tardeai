...
**Operational note (2026-09-20):** destructive `r10` rebuild in the test harness drops v2
packaging aliases/views/trigger until `trade-ai-bitemporal-schema-v2.sql` is re-applied —
wire both files into every isolated bootstrap.
