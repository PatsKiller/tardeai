...
# _get_earnings_dates (FMP) removed 2026-09-13: dead since the 07-20 403; earnings come from
# symbol_profiles.next_earnings_date via earnings_provider. config/data_source_authority.json.
