...
release can be staged without a code change:
  ...
  MEMORY_BEHAVIOR_INFLUENCE_OPTIONS — scoped options/CIO memory envelope (default 0)
  MEMORY_ADVERSARIAL_SCAN     — jailbreak/instruction-override reject at admission (default 0)
...
# Scoped: options/CIO "what we learned" envelope only. Does NOT flip global
# MEMORY_BEHAVIOR_INFLUENCE. Default 0 — lab/live pin required to enable.
...
INT_FLAG_NAMES: tuple[str, ...] = (
    ...
    "MEMORY_BEHAVIOR_INFLUENCE_OPTIONS",
    "MEMORY_ADVERSARIAL_SCAN",
...
DEFAULT_FLAGS: dict[str, Any] = {
    ...
    "MEMORY_BEHAVIOR_INFLUENCE_OPTIONS": DEFAULT_MEMORY_BEHAVIOR_INFLUENCE_OPTIONS,
    "MEMORY_ADVERSARIAL_SCAN": DEFAULT_MEMORY_ADVERSARIAL_SCAN,
