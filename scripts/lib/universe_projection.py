...
def build_universe_projection(
    *,
    ...
    return {
        ...
        "cohort": "thesis_and_material_projection",
        ...
        "denominators": {
            ...
            "research_universe": {
                ...
                "is_not_transferson_universe": True,
            },
            "note": "Thesis/material projection. Transferson canonical universe is TransfersonUniverseManifest@v1.",
        },
