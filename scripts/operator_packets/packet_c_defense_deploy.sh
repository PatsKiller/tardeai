...
PREPARE-ONLY: no release SHA supplied. Nothing was deployed. This packet refuses to mutate.
  usage: $0 <RELEASE_SHA> --execute --deploy --ack-deploy $ACK_DEPLOY
         $0 <RELEASE_SHA> --execute --switch-breadth --ack-switch $ACK_SWITCH   (after (1)+(2))
         $0 <RELEASE_SHA> --execute --rollback-static|--rollback-backend|--rollback-payload
         $0 <RELEASE_SHA> --execute --rollback-breadth <backup_dir>
