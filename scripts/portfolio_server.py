...
class PortfolioHandler(http.server.BaseHTTPRequestHandler):
    ...
    def _do_GET_inner(self):
        ...
        if path == "/api/env/read":
            ...
            _SENS = {"ANTHROPIC_API_KEY","FINVIZ_API_TOKEN","FINVIZ_COOKIE","TELEGRAM_BOT_TOKEN"}
            _SHOW = {"FINVIZ_COOKIE","FINVIZ_API_TOKEN","TELEGRAM_CHAT_ID","ENABLE_TELEGRAM","TELEGRAM_BOT_TOKEN","BRAVE_SEARCH_API_KEY","OPENAI_API_KEY","ANTHROPIC_API_KEY","CLAUDE_CHEAP_MODEL","CLAUDE_ESCALATION_MODEL","GEMINI_API_KEY","ALPHA_VANTAGE_API_KEY","YOUTUBE_API_KEY","YOUTUBE_COOKIE","FRED_API_KEY","TIMEZONE","ENABLE_EMAIL","ENABLE_WHATSAPP","ENABLE_SLACK","FINVIZ_NEWS_ENABLED","YAHOO_NEWS_ENABLED","ERROR_NOTIFY_TELEGRAM","GENERATE_PDF","GENERATE_DOCX","GENERATE_TOS"}
            _flds = []
            if _env.exists():
