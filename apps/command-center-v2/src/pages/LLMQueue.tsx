...
function ScheduleTab() {
  ...
  const SCHEDULE = [
    ...
    { type: 'recovery_watch_review', label: 'Recovery Watch', days: [0,1,0,1,0,0,0], note: 'Tue/Thu + event triggers' },
    { type: 'income_strategy_scan', label: 'Income Strategy Scan', days: [1,0,0,0,0,0,0], note: 'Monday: income/dividend universe' },
    { type: 'growth_strategy_scan', label: 'Growth Strategy Scan', days: [0,0,1,0,0,0,0], note: 'Wednesday: growth/sector/defense' },
    { type: 'reversion_strategy_scan', label: 'Reversion Strategy Scan', days: [0,0,0,0,0,1,0], note: 'Saturday: pullbacks/bonds/cash' },
    { type: 'covered_call_scoring', label: 'Covered Call Scoring', days: [0,0,0,0,0,0,1], note: 'Sunday + event triggers' },
    { type: 'strategy_opportunity_scan', label: 'Strategy Opportunity Scan', days: [0,0,0,0,0,0,1], note: 'Sunday: full diversity scan' },
