...
export const AGENT_RUNTIME_SOURCE_AS_OF = '2026-07-31T15:30:00Z'
...
export const AGENT_RUNTIME_CATALOG: AgentRuntimeDefinition[] = [
  ...
  },
  {
    ...
    allowedTools: ['kb.search', 'kb.get_lesson', 'kb.get_case', 'lesson_review.write', 'contradiction.write'], deniedTools: ['lesson.ratify', 'config.promote', 'hypothesis.promote', 'kb.write', 'lesson.retire'], budget: zeroCost(600, 16, 3),
  ...
  {
    agentId: 'maria', displayName: 'Maria', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'research-owner',
  ...
  {
    agentId: 'vega', displayName: 'Vega', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'technical-research-owner',
  ...
  {
    agentId: 'pulse', displayName: 'Pulse', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'microstructure-owner',
  ...
  {
    agentId: 'steph', displayName: 'Steph', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'portfolio-owner',
  ...
  {
    agentId: 'risk_agent', displayName: 'Guardian Risk', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'risk-owner',
  ...
  {
    agentId: 'tax_agent', displayName: 'Ledger Tax', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'tax-owner',
  ...
  {
    agentId: 'hermes', displayName: 'Hermes', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'research-owner',
  ...
  {
    agentId: 'aegis', displayName: 'Aegis', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'reliability-owner',
  ...
  {
    agentId: 'alex', displayName: 'Alex', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'cio-owner',
  ...
  {
    agentId: 'concierge', displayName: 'Concierge', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'operator-experience-owner',
  ...
  {
    agentId: 'atlas', displayName: 'Atlas', lifecycle: 'SHADOW', enabled: true, version: '1.0.0-shadow', owner: 'architecture-owner',
