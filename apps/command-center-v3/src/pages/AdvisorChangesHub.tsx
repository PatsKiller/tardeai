// Advisory-only changelog hub for the rotation / LLM second-opinion feature.
// Every card describes a review/second-opinion capability — no broker action is implied.
...
export default function AdvisorChangesHub() {
  return (
    <div style={{ padding: 4 }}>
      <header style={{ marginBottom: 18 }}>
        <div style={{ fontSize: 20, fontWeight: 700, color: 'var(--text0)' }}>Advisor Changes</div>
        <div style={{ fontSize: 12, color: 'var(--text2)', marginTop: 3 }}>
          Advisory-only rotation and LLM second-opinion work — what each piece improves and how to validate it.
        </div>
