      ...
      {tab === 'Trades' && (
        <>
          ...
          {/* P0-6: TradeInView stats = broker round-trips — a DIFFERENT (and fresher) basis than the
              global header's Journal tiles (legacy FIFO journal). Label it so the mismatch is
          ...
          <div style={{ fontSize: 12, color: 'var(--text3)', margin: '-8px 0 14px', lineHeight: 1.4 }}>
            ...
            The header&apos;s Journal tiles use the legacy FIFO journal (older history, $0 scratches
