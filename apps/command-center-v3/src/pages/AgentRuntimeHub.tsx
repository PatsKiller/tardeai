...
export default function AgentRuntimeHub({ onDrill }: Props) {
  ...
  return <div>
    ...
    {view === 'Legacy analytics' && <AgentsHub onDrill={onDrill} />}
    <div style={{ marginTop: 14, fontSize: 11, color: 'var(--text3)' }}>AUTO-PROMOTION TO TRADING: DISABLED · READ_ONLY_ADVISORY</div>
  </div>
}
