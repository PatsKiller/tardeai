...
export default function ReEntryCurrentIntelligence() {
  ...
  return <div style={{ ...panel, padding: 10 }}>
    ...
    <div style={{ overflowX: 'auto', marginTop: 8 }}><div style={{ minWidth: 1490 }}><div style={{ display: 'grid', gridTemplateColumns: '28px 180px 220px 125px 150px 170px 160px 150px 130px', gap: 8, padding: '7px 9px', borderBottom: '1px solid var(--border)', fontSize: 10, color: BB.text3, textTransform: 'uppercase' }}><span></span><span>Symbol / mandate</span><span>Current decision</span><span>Market</span><span>Exit evidence</span><span>Entry / resistance</span><span>Valuation / analyst</span><span>Evidence coverage</span><span>Actions</span></div>{shown.map(row => {
